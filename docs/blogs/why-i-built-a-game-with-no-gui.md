...
There's a [Python starter client](https://github.com/api-combat-game/python-starter) that plays through the full game loop in ~200 lines. But that's just a starting point.
...
**Python starter:** [github.com/api-combat-game/python-starter](https://github.com/api-combat-game/python-starter)
